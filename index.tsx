...
async function generate() {
  ...
  try {
    ...
    for (let i = 0; i < 4; i++) {
        ...
        finalPrompt += `\n7. **СТИЛЬ И МОЛОДОСТЬ (Beauty filter):**
*   **Омоложение:** Сделай лицо визуально моложе и свежее. Кожа должна быть идеально гладкой, фарфоровой и сияющей (Glow effect). Примени эффект "High-End Beauty Retouch".
*   **Свет:** Используй мягкое, рассеянное студийное освещение (Softbox Beauty Lighting/High-key lighting), который убирает все морщинки и тени с лица. Полностью исключи жесткие тени.
*   **Детали:** Глаза должны блестеть, взгляд должен быть ясным и чистым. Полностью убери усталость, мешки под глазами и носогубные складки.
*   **Атмосфера:** Глянцевая бьюти-фотография. Цвета чистые и свежие.`;
...
6. **СТИЛЬ И МОЛОДОСТЬ (Beauty filter):**
*   **Омоложение:** Сделай лицо визуально моложе и свежее. Кожа должна быть идеально гладкой, фарфоровой и сияющей (Glow effect). Примени эффект "High-End Beauty Retouch".
*   **Свет:** Используй мягкое, рассеянное студийное освещение (Softbox Beauty Lighting/High-key lighting), который убирает все морщинки и тени с лица. Полностью исключи жесткие тени.
*   **Детали:** Глаза должны блестеть, взгляд должен быть ясным и чистым. Полностью убери усталость, мешки под глазами и носогубные складки.
*   **Атмосфера:** Глянцевая бьюти-фотография. Цвета чистые и свежие.
