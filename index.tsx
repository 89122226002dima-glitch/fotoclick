...
Изображение 2 — это РЕФЕРЕНС ОДЕЖДЫ.

КРИТИЧЕСКИ ВАЖНЫЕ, НЕУКОСНИТЕЛЬНЫЕ ПРАВИЛА:
1.  **АБСОЛЮТНАЯ ИДЕНТИЧНОСТЬ ЧЕЛОВЕКА:** Человек на итоговом фото должен быть точной, 1-в-1 копией человека с **Изображения 1**. Его лицо, черты лица (нос, глаза, губы), цвет кожи, прическа, выражение лица и поза должны быть сохранены без малейших изменений. Это главное правило. Любое изменение внешности человека с Изображения 1 — это провал.
2.  **ИГНОРИРУЙ ЧЕЛОВЕКА НА ВТОРОМ ФОТО:** На **Изображении 2** (одежда) может быть другой человек. Ты должен **ПОЛНОСТЬЮ ИГНОРИРОВАТЬ** этого человека. Не бери его внешность, лицо, позу или что-либо еще. Используй с Изображения 2 **ТОЛЬКО И ИСКЛЮЧИТЕЛЬНО ОДЕЖДУ**.
...
4.  **СОХРАНИ ФОРМАТ И КАДРИРОВАНИЕ:** Итоговое изображение должно иметь точно такое же соотношение сторон, композицию и кадрирование, как у **Изображения 1**. Формат и композиция Изображения 2 нужно полностью игнорировать.
