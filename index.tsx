...
5.  **АДАПТИРУЙ ОСВЕЩЕНИЕ И ЦВЕТ:** Используй мягкий, объемный свет. Добавь популярные варианты цветокоррекции и тонирования ИЛИ кинематографичную цветокоррекцию , чтобы изображение выглядело как дорогой профессиональный снимок.
6.  Поза и выражение лица ОБЯЗАТЕЛЬНО должны остаться без изменения.
**КАЧЕСТВО:** СТАНДАРТНОЕ ВЕБ КАЧЕСТВО.
Результат — только одно изображение без текста.`;
            } else {
